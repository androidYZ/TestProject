...
public class SpUtil {
    ...
    private SpUtil() {
        mSharedPreferences = TApplication.sInstance.getSharedPreferences("SharedPreferences", Context.MODE_PRIVATE);
    }
     ...
     * 获取一个字符串
     */
    public String getStringValue(String key,String defalue) {
        return mSharedPreferences.getString(key,defalue);
    }
